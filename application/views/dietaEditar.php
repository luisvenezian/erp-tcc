...
<?php echo form_open_multipart('produto/dietaAtualizar'); ?>
...
<div class="form-group">
        ...
        <select class="browser-default custom-select" name="unidade" id='unidade'>
                ...
                <option value="tonelada" <?= ($produto->unidade == 'tonelada') ? 'selected' : '' ?>>TONELADA</option>
        </select>
</div>
<div class="form-group">
                <label for="ganhoPeso">Ganho de Peso por Dia</label>
                <input type="number" class="form-control" id="ganhoPeso" value="<?php echo ($produto->ganhoPeso) ?>" name="ganhoPeso" aria-describedby="ganhoPesoHelp" placeholder="Digite o valor de ganho">
</div>
<div class="form-group">
...
<div class="btn-group">
        ...
        <?php echo form_open_multipart('produto/dietaExcluir'); ?>
        <input type="hidden" name="id" value="<?php echo ($produto->idProduto) ?>">
